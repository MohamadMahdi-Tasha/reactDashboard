            ...
            <div>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <img src={ImagePerson1} alt="Darby Day"/>
                                <span>Darby Day</span>
                            </td>
                            ...
                            <td>
                                <button>
                                    <svg width="18" height="5" viewBox="0 0 18 5" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9 0.5C8.60444 0.5 8.21776 0.617298 7.88886 0.837061C7.55996 1.05682 7.30362 1.36918 7.15224 1.73463C7.00087 2.10009 6.96126 2.50222 7.03843 2.89018C7.1156 3.27814 7.30608 3.63451 7.58579 3.91421C7.86549 4.19392 8.22186 4.3844 8.60982 4.46157C8.99778 4.53874 9.39992 4.49913 9.76537 4.34776C10.1308 4.19638 10.4432 3.94004 10.6629 3.61114C10.8827 3.28224 11 2.89556 11 2.5C11 1.96957 10.7893 1.46086 10.4142 1.08579C10.0391 0.710714 9.53043 0.5 9 0.5ZM2 0.5C1.60444 0.5 1.21776 0.617298 0.88886 0.837061C0.559962 1.05682 0.303617 1.36918 0.152242 1.73463C0.000866562 2.10009 -0.0387401 2.50222 0.0384303 2.89018C0.115601 3.27814 0.306082 3.63451 0.585787 3.91421C0.865492 4.19392 1.22186 4.3844 1.60982 4.46157C1.99778 4.53874 2.39992 4.49913 2.76537 4.34776C3.13082 4.19638 3.44318 3.94004 3.66294 3.61114C3.8827 3.28224 4 2.89556 4 2.5C4 1.96957 3.78929 1.46086 3.41421 1.08579C3.03914 0.710714 2.53043 0.5 2 0.5ZM16 0.5C15.6044 0.5 15.2178 0.617298 14.8889 0.837061C14.56 1.05682 14.3036 1.36918 14.1522 1.73463C14.0009 2.10009 13.9613 2.50222 14.0384 2.89018C14.1156 3.27814 14.3061 3.63451 14.5858 3.91421C14.8655 4.19392 15.2219 4.3844 15.6098 4.46157C15.9978 4.53874 16.3999 4.49913 16.7654 4.34776C17.1308 4.19638 17.4432 3.94004 17.6629 3.61114C17.8827 3.28224 18 2.89556 18 2.5C18 1.96957 17.7893 1.46086 17.4142 1.08579C17.0391 0.710714 16.5304 0.5 16 0.5Z" fill="white"/>
                                    </svg>
                                </button>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <img src={ImagePerson2} alt="Helt Diven"/>
                                <span>Helt Diven</span>
                            </td>
                            <td>On Going</td>
                            <td>$299,000</td>
                            <td>
